...
CKPT_ARGS=(
   --hf-checkpoint /root/data/hf_models/Qwen3-1.7B
   --ref-load /root/data/mega-models/Qwen3-1.7B
   --load /root/data/mega-models/Qwen3-1.7B_slime/
   --save /root/data/mega-models/Qwen3-1.7B_slime/
   --save-interval 20
)

ROLLOUT_ARGS=(
   --prompt-data /root/data/datasets/dapo-math-17k.jsonl
   --input-key prompt
   --apply-chat-template
   --rollout-shuffle
   --num-rollout 300
